...
public class URLS {
    ...
    private static final String URL_ROOT = "http://192.168.43.114/athleticskenya/muriithi/Operations.php?action=";//136.243.75.214:2082 76-kevin 212-erick 114-me
    ...
    static final String URL_RECOVER_PASSWORD = URL_ROOT + "recover_password";
    static final String URL_CHANGE_PASSWORD = URL_ROOT + "change_password";

    /**
     *fetching accepted athletes by coaches using contact id used in AcceptedAthletes Activity
     */
    static final String URL_ACCEPTED = "http://192.168.43.114/athleticskenya/muriithi/Coach_athlete.php?contact=";
    /**
     *fetching all chats by receiver id used in ChatRoom Activity
     */
    static final String URL_CHATS = "http://192.168.43.114/athleticskenya/muriithi/Chats.php?id=";
    /**
     *fetching all athlete requests to coaches by coach id used in Coach_Athlete_Request Activity
     */
    static final String URL_REQUEST = "http://192.168.43.114/athleticskenya/muriithi/Request.php?id=";
    /**
     ...
     * activity
     */
    static final String URL_BREAKFAST = "http://192.168.43.114/athleticskenya/muriithi/Breakfast.php?id=";
    static final String URL_LUNCH = "http://192.168.43.114/athleticskenya/muriithi/Lunch.php?id=";
    static final String URL_DINNER = "http://192.168.43.114/athleticskenya/muriithi/Dinner.php?id=";
    /**
     *fetching a coach to athlete using contact id used in MyCoach Activity
     */
    static final String URL_MY_COACH = "http://192.168.43.114/athleticskenya/muriithi/Coach.php?contact=";

    public static final String URL_NOTIFICATIONS = "http://192.168.43.114/athleticskenya/muriithi/notifications.php?id=";//used is NotificationsFragment
