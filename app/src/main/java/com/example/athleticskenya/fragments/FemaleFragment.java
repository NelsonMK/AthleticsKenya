...
public class FemaleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        return  inflater.inflate(R.layout.female, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.femaleRecycler);
    ...
    private void loadServerAwards() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URLS.URL_FEMALE_AWARDS,
