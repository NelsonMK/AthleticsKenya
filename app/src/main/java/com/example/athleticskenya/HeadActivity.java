...
public class HeadActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                relativeLayout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        startActivity(new Intent(HeadActivity.this, ProfileActivity.class));
        ...
        firstname = header.findViewById(R.id.head_profile_firstname);
        firstname.setText(user.getFirstname());
        lastname = header.findViewById(R.id.head_profile_lastname);
        lastname.setText(user.getLastname());
        profile_pic = header.findViewById(R.id.head_profile_picture);
        Glide.with(this)
                .load(user.getImage())
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EventsAdapter adapter = new EventsAdapter(HeadActivity.this, eventsList);
