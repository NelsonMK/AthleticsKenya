...
public class ManagerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstname = header.findViewById(R.id.manager_profile_firstname);
        firstname.setText(user.getFirstname());
        lastname = header.findViewById(R.id.manager_profile_lastname);
        lastname.setText(user.getLastname());
        profile_pic = header.findViewById(R.id.manager_profile_picture);
        Glide.with(this)
                .load(user.getImage())
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EventsAdapter adapter = new EventsAdapter(ManagerActivity.this, eventsList);
